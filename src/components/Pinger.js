...
export default function Pinger() {
  ...
  const [showChannelBar, setShowChannelBar] = useState(true);

  const toggleShowUserBar = () => {
    if (showChannelBar && !showUserBar && window.innerWidth < 500) {
      setShowChannelBar(false);
    }
    setShowUserBar(!showUserBar);
  };
  const toggleShowChannelBar = () => {
    if (!showChannelBar && showUserBar && window.innerWidth < 500) {
  ...
  return (
    <div className="pinger">
        ...
        <>
          <div className="pinger__serverbar">
            ...
            <div className="serverbar__addserver">
              ...
              <div
                className="serverbar__close"
                onClick={() => setShowChannelBar(false)}
              >
                <HighlightOffIcon />
              </div>
            </div>
          ...
          <div className="pinger__channelbar">
            ...
            <div className="chanels__main">
              ...
              <div className="channels">
                <div className="channels__serverName">
                  {crntServer.server_name}
                </div>
            ...
            <div className="currentUser__cont">
              <div className="currentUser__avatar__cont">
                ...
                />
                <div
                  className={"currentUser__avatar__status " + user.status}
                ></div>
              </div>
      ...
      <div className="pinger__chatbar">
        <div
          className="pinger__toggleUsers"
          onClick={() => toggleShowUserBar()}
        >
          <PeopleAltIcon />
        </div>
        {showChannelBar ? (
          <div
            className="pinger__toggleChannels"
            onClick={() => toggleShowChannelBar()}
          >
            <MenuOpenIcon />
          </div>
        ) : (
      ...
      {showUserBar && (
        <div className="pinger__usersbar">
          {Array.isArray(crntServer.users) && (
            <>
              <div
                className="userbar__closeuserbar"
                onClick={() => setShowUserBar(false)}
              >
                <HighlightOffIcon />
              </div>
